...
//连接池
const db=mysql.createPool({host: 'localhost', user: 'root', password: 'lp1435075638', database: 'blog'});
...
//3.post数据
//bodyParser.urlencoded默认键值对为任何类型，修改为false后就只能是String和Array了
server.use(bodyParser.urlencoded({extended: false}));
//处理特殊的上传（可多个文件上传，上传的文件的目录是./www/upload
